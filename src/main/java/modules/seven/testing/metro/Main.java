...
public class Main {
    ...
    private static String dataFile = "src/main/java/modules/seven/testing/metro/resources/map.json";
    ...
    public static void main(String[] args) {
        ...
        exceptionLogger = LogManager.getLogger("Exception");
        ...
        for (; ; ) {
            try {
                ...
                if (true) throw new NullPointerException(" Example ");
            } catch (Exception ex) {
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                rootLogger.info("Станция найдена: " + line);
                return station;
            }
            System.out.println("Станция не найдена :(");
            rootLogger.error("Станция не найдена: " + line);
        }
    }
